  ...
  try {
    ...
    const { data: conflict, error: errorConflict } = await db
      ...
      .upsert({
        ...
        conflict_reason: 'These assumptions directly contradict each other regarding Q1 budget expectations',
        confidence_score: 0.95,
        metadata: {
          detected_by: 'manual_test',
          notes: 'Budget cannot both remain at $50k and be reduced by 30%'
        }
