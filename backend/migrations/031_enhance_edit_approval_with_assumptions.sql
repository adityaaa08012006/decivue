-- Migration 031: Enhance edit approval to handle assumption changes
-- Adds support for linking/unlinking assumptions in edit requests

-- Drop and recreate the resolve_edit_request function with assumption handling
...
-- Migration complete
COMMENT ON FUNCTION resolve_edit_request IS 'Resolves edit approval requests with support for field changes and assumption linking/unlinking';
