...
"Increase Marketing Budget","Allocate $200k for Q2 campaigns","Budget & Financial","Market conditions favorable;ROI target 3x","Budget Policy","2026-06-30"`;
  ...
  const getCategoryColor = (category) => {
    const colors = {
      'Strategic Initiative': 'bg-purple-100 text-purple-700',
      'Budget & Financial': 'bg-green-100 text-green-700',
      'Technical Initiative': 'bg-blue-100 text-blue-700',
      'Policy & Compliance': 'bg-orange-100 text-orange-700',
                ...
                {extractedData.map((decision, index) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <input
                          ...
                          className="text-lg font-semibold text-gray-800 w-full border-b border-transparent hover:border-gray-300 focus:border-blue-500 outline-none px-1 -ml-1"
                        />
                        <div className="flex items-center gap-2 mt-2">
                          <select
                            value={decision.category || ''}
                            onChange={(e) => handleEditDecision(index, 'category', e.target.value)}
                            className={`text-xs px-2 py-1 rounded-full font-medium ${getCategoryColor(decision.category)}`}
                          >
                            ...
                            <option value="Technical Initiative">Technical Initiative</option>
                    ...
                    <textarea
                      ...
                      className="w-full text-sm text-gray-600 border border-gray-200 rounded p-2 hover:border-gray-300 focus:border-blue-500 outline-none resize-none"
                      rows={2}
                      ...
                      <div className="mt-3">
                        ...
                        <div className="space-y-1">
                          {decision.assumptions.map((assumption, ai) => (
                            <div
                              key={ai}
                              className="flex items-start gap-2 text-sm text-gray-600 bg-gray-50 p-2 rounded group"
                            >
